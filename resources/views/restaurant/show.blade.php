  ...
  <div class="pt-6">
    <nav aria-label="Breadcrumb">
      <ol role="list" class="mx-auto flex max-w-2xl items-center space-x-2 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
        ...
        <li>
          <div class="flex items-center">
            <a href="/hotel/mombasa" class="mr-2 text-sm font-medium text-gray-900">Mombasa Beach Hotel</a>
            <svg width="16" height="20" viewBox="0 0 16 20" fill="currentColor" aria-hidden="true" class="h-5 w-4 text-gray-300">
              <path d="M5.697 4.34L8.98 16.532h1.327L7.025 4.341H5.697z" />
            </svg>
          </div>
        ...
        <li class="text-sm">
          <a href="/accommodation/{{ $restaurant->id }}" aria-current="page" class="font-medium text-gray-500 hover:text-gray-600">{{ $restaurant->name }}</a>
        </li>
      </ol>
    </nav>
     <header>
    ...
    <div class="mx-auto max-w-2xl px-4 pt-10 pb-16 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto_auto_1fr] lg:gap-x-8 lg:px-8 lg:pt-16 lg:pb-24">
      ...
      <div class="mt-4 lg:row-span-3 lg:mt-0">
        ...
        <!-- fetch package cost  -->
        <a href="/hotel/{{ $restaurant->hotel_tag }}" class="text-3xl tracking-tight text-gray-900 uppercase">{{ $restaurant->hotel_tag }}</a>
        ...
        <form method="POST" action="/add-to-cart/{{ $restaurant->id }}" class="mt-10">
          @csrf
