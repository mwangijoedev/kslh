<x-layout1>
  ...
  <!-- form -->
  <form method="POST" action="/restaurant/store" class="md:mx-30 md:mb-20 p-5 glass h-screen overflow-scroll no-scrollbar" enctype="multipart/form-data" >
      @csrf
<!-- Inputs  -->
      ...
      <div class=" md:col-span-1" id="closure 1">
          ...
          <div class="col-span-full">
            <div class="w-full mt-2 grid grid-cols-1">
              <label for="location" class="text-xs text-gray-300 mb-2 ">Location</label>
                <input type="text" name="location" id="location" autocomplete="location" class="rounded-md bg-gray-100/20 px-3 py-1.5 text-base text-black placeholder:text-gray-400 focus:outline-none sm:text-sm/6" placeholder="Mombasa">
          ...
          <div class="col-span-full">
            <div class="w-full mt-2 grid grid-cols-1">
              ...
              <select id="service_tag" name="service_tag" autocomplete="service_tag" class="rounded-md bg-gray-100/20 px-3 py-1.5 text-base text-black placeholder:text-gray-400 focus:outline-none sm:text-sm/6">
          ...
          <div class="col-span-full">
            <div class="w-full mt-2 grid grid-cols-1">
              <label for="operating_hours" class="text-xs text-gray-300  mb-2">Operating hours</label>
                <input type="text" name="operating_hours" id="operating_hours" autocomplete="time" class="rounded-md bg-gray-100/20 px-3 py-1.5 text-base text-black placeholder:text-gray-400 focus:outline-none sm:text-sm/6" placeholder="e.g. 8:00 AM - 10:00 PM">
