  ...
  <div class="pt-6">
    <nav aria-label="Breadcrumb">
      <ol role="list" class="mx-auto flex max-w-2xl items-center space-x-2 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
        ...
        <li class="text-sm">
          <a href="/accommodation/{{ $room->id }}" aria-current="page" class="font-medium text-gray-500 hover:text-gray-600">{{ $room->name }}</a>
        </li>
      </ol>
    </nav>
    ...
    <div class="mx-auto max-w-2xl px-4 pt-10 pb-16 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto_auto_1fr] lg:gap-x-8 lg:px-8 lg:pt-16 lg:pb-24">
      ...
      <div class="mt-4 lg:row-span-3 lg:mt-0">
        ...
        <!-- fetch package cost  -->
        <a href="/hotel/{{ $room->hotel_tag }}" class="text-3xl tracking-tight text-gray-900 uppercase">{{ $room->hotel_tag }}</a>
      ...
      <div class="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pt-6 lg:pr-8 lg:pb-16">
        ...
        <div>
          ...
          <div class="space-y-6">
            <div class="text-base text-gray-300">{{$room->description}}! 🌴🐘🌊 
              <br>
        ...
        <div class="mt-4">
            <ul role="list" class="list-disc space-y-2 pl-4 text-sm">
              ...
              <li class="text-gray-400"><span class="text-gray-600">✔ {{ $amenity }} ✨🚀</span></li>  
              @endforeach
            </ul>
          </div>
        </div>
