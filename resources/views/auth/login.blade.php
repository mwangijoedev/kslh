        ...
        <form method="POST" action="{{ route('login') }}" class=" z-3 " >
            ...
            <div class="flex items-center justify-end mt-4">
                ...
                <div class="grid grid-cols-2 gap-2">
                    <a class="underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-hidden focus:ring-2 focus:ring-offset-2 focus:ring-transparent dark:focus:ring-offset-gray-800" href="{{ route('register') }}">
                         {{ __('Create account') }}
                    </a>
                    <a class="underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-hidden focus:ring-2 focus:ring-offset-2 focus:ring-transparent dark:focus:ring-offset-gray-800" href="{{ route('password.request') }}">
