<x-layout1>
    ...
    <form method="POST" action="/bar/store" class="md:mx-30 md:mb-20 p-5 glass h-screen overflow-scroll no-scrollbar" enctype="multipart/form-data" >
        @csrf
        <!-- Inputs  -->
    <!--Closure 1 -->   
        ...
        <div class=" md:col-span-1">
                ...
                <div class="col-span-full">
                    <div class="w-full mt-2 grid grid-cols-1">
                        <label for="image" class="text-sm text-gray-300 ">Upload Bar Image</label>
                            <div class="mt-2">
    ...
    <!-- Closure 2 -->
        <div class="md:col-span-1">
            ...
            <div class="col-span-full">
                <div class="w-full mt-2 grid grid-cols-1">
                <label for="service_tag" class="text-xs text-gray-300  mb-2">Service</label>
                    <textarea name="service_tag" id="service_tag" rows="2" autocomplete="service_tag" class="rounded-md bg-gray-100/20 px-3 py-1.5 text-base text-black placeholder:text-gray-400 focus:outline-none sm:text-sm/6"></textarea>
