<div>
  ...
  <!-- form -->
   <div class="md:mx-30 md:mb-20 rounded-sm bg-gray-950 h-screen">
        <form wire:submit.prevent="save" wire:confirm="Save This Restaurant ?" class="md:mb-20 p-5 glass bg-gray-950 h-screen overflow-scroll no-scrollbar" enctype="multipart/form-data" >
          @csrf
    <!-- Inputs  -->
    ...
    <!-- submit button  -->
      ...
      <div class="absolute right-50 mt-15">
          <a wire:navigate href="/create-bar"
