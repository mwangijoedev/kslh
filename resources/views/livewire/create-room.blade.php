<div>
    ...
    <header>
      <h2 class="text-gray-300 my-2 text-lg sm:text-4xl text-center font-audiowide">CREATE A NEW ROOM</h2>
    </header>
   <div class="md:mx-30 md:mb-20 rounded-sm bg-gray-950 h-screen">
    <form wire:submit.prevent="save" wire:confirm="Save This Room ?" class="md:mb-20 p-5 glass bg-gray-950 h-screen overflow-scroll no-scrollbar" enctype="multipart/form-data" >
        @csrf
      <!-- Inputs  -->
    ...
    <!-- Closure 2  -->
      ...
      <div class="absolute right-50 mt-15">
          <a wire:navigate href="/create-restaurant"
