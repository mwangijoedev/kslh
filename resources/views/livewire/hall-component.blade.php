<div class="bg-gray-950">
    <div class="bg-gray-950 pb-20 select-none">
        <div class="pt-6">
            <header>
                <h2 class="text-gray-300 my-2 text-lg sm:text-4xl text-center font-audiowide">{{$hall->name}}</h2>
            </header>
                ...
                <div class="mt-4 lg:row-span-3 lg:mt-0">
                        <div class=" max-w-2xl sm:px-2 flex flex-col justify-center items-center ">
                            ...
                            <div class="mt-5 font-audiowide uppercase text-amber-800 text-center">
                              <a href="/hall/{{ $next->id }}" wire:navigate class="text-sm cursor-pointer font-bold ">View&nbsp;{{ $next->name }}
                                <span aria-hidden="true">&rarr;</span>
                              </a>
                            </div>
                                         
                            <a wire:navigate href="/halls"
        ...
        <div class="mx-auto max-w-2xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-x-8 lg:px-8">
            <div class="col-span-1 mt-4 lg:row-span-3 lg:mt-0">
                <a href="/hotel/{{ $hall->hotel_tag }}" class="text-3xl tracking-tight text-gray-700 uppercase">{{ $hall->hotel_tag }}</a>
                <div class="mt-6">
                ...
                <form method="POST" action="/book/{{ $hall->id }}" class="mt-10">
                    @csrf
