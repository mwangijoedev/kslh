                    ...
                    <div class="mt-4 lg:row-span-3 lg:mt-0">
                        <div class=" max-w-2xl sm:px-2 flex flex-col justify-center items-center ">
                            ...
                            <div class="mt-5 font-audiowide uppercase text-amber-800 text-center">
                              <a href="/restaurant/{{ $next->id }}" wire:navigate class="text-sm cursor-pointer font-bold ">View&nbsp;{{ $next->name }}
                                <span aria-hidden="true">&rarr;</span>
                              </a>
                            </div>
                                         
                            <a wire:navigate href="/restaurants"
                    ...
                    <form method="POST" action="/book/{{ $restaurant->id }}" class="mt-10">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <h3 class="text-base font-semibold text-gray-800">
                                {{ $restaurant->service_tag }}
                            </h3>
                            <!-- Right: Hotel Link -->
                            <a href="/hotel/{{ $restaurant->hotel_tag }}" wire:navigate
