<div>
    ...
    <header>
      <h2 class="text-gray-300 my-2 text-4xl text-center font-audiowide ">CREATE A HALL</h2>
    </header>
   <div class="md:mx-30 md:mb-20 rounded-sm bg-gray-950 h-screen">
      <form wire:submit.prevent="save" wire:confirm="Save This Hall ?" class="md:mb-20 p-5 glass bg-gray-950 h-screen overflow-scroll no-scrollbar" enctype="multipart/form-data" >
          @csrf
          <!-- Inputs  -->
      <!--Closure 1 -->   
          ...
          <div class=" md:col-span-1">
                  ...
                  <div class="col-span-full">
                      ...
                      <label for="name" class="text-xs text-gray-300 mb-2 ">Hall name</label>
      ...
      <!-- Closure 2 -->
          ...
          <!-- submit button  -->
            ...
            <div class="absolute right-50 mt-15">
                <a wire:navigate href="/create-event"
