    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        @method('patch')
         ...
         <div id="photo">
            ...
            <x-text-input id="photo" name="photo" type="file" class="mt-1 block w-full px-2 py-2" :value="old('photo', $user->photo)"  accept="image/*" required autofocus autocomplete="photo" />
