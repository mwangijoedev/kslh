        ...
        <nav x-data="{ open: false }" class="p-4 lg:px-8 shadow-xl relative z-10">
            <div class="flex items-center justify-between">
                ...
                <div class="hidden lg:flex gap-x-8 font-audiowide text-sm text-gray-400">
                    <a href="/todos" wire:navigate @class(['current'=>request()->is('/todos')]) class="hover:text-amber-700 transition">todos</a>
                    <a href="/counter" wire:navigate @class(['text-amber-700'=>request()->is('counter'), 'hover:text-amber-700 transition' => true]) >counter</a>
                    <a href="/posts" wire:navigate @class(['current'=>request()->is('/posts')]) class="hover:text-amber-700 transition">posts</a>
            ...
            <div x-show="open" x-transition class="mt-4 lg:hidden space-y-4 text-sm font-audiowide text-gray-200">
                <a href="/todos" @class(['text-amber-700'=>request()->is('/todos')]) class="hover:text-amber-700 transition">todos</a>
                <a href="/counter" @class(['text-amber-700'=>request()->is('/counter')]) class="hover:text-amber-700 transition">counter</a>
                <a href="/counter" @class(['text-amber-700'=>request()->is('/counter')]) class="hover:text-amber-700 transition">counter</a>
